...
module.exports = class PerDocumentResourceLoader {
  ...
  fetch(url, { element, onLoad, onError }) {
    // This can happen when you create a document with `createHTMLDocument` which does not get a `_defaultView`
    // This return is a quick dirty fix for https://github.com/jsdom/jsdom/issues/2553 since we don't need the remote resources in our use case
